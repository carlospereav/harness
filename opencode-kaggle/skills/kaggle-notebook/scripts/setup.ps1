...
Write-Host "  python opencode-kaggle/skills/kaggle-notebook/scripts/kaggle_nb.py setup"
Write-Host "  python opencode-kaggle/skills/kaggle-notebook/scripts/kaggle_nb.py new my-notebook"
Write-Host "  python opencode-kaggle/skills/kaggle-notebook/scripts/kaggle_nb.py push my-notebook"